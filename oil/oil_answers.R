...
ggplot(combined, aes(x=year)) +
  geom_line(aes(y=ny_conventional, color="New York Conventional")) +
  geom_line(aes(y=gulf_conventional, color="Gulf Coast Conventional")) +
  geom_line(aes(y=la_rbob, color="Los Angeles RBOB"))
