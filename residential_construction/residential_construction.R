...
permits_2000s = read_csv("residential_construction/data/res_permits_2000s.csv")
permits_2010s = read_csv("residential_construction/data/res_permits_2010s.csv")
permits_2020s = read_csv("residential_construction/data/res_permits_2020s.csv")
county_types = read_csv("residential_construction/data/county_types.csv")
