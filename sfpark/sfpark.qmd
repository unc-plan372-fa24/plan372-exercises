...
One option would be to create a histogram of the data, showing the general distribution of the total number of entries.

```{r}
ggplot(citywide_entries, aes(x=entries)) +
  geom_histogram()
```

Most days have between 12500 and 22500 entries. This chart doesn't let us see trends over time, however.
