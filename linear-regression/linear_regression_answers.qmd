...
# answer
no_outliers = data |>
    filter(heatedarea < 5000 & amt_price < 2000000)
...
candidate_sites = tribble(
    ~heatedarea, ~year_of_sale, ~siding,      ~area,
    2000,        2021,          "HARDIPLANK", "03103",
    2000,        2021,          "HARDIPLANK", "03105",
    2000,        2021,          "HARDIPLANK", "03108",
)
