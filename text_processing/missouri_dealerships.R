...
dealers = str_split(str, "your regex here")[[1]]
...
dealer_info_line = first(dealer[str_detect(dealer, "your regex here")])
...
dealer_info = str_match(dealer_info_line, "your regex here")
...
count_lines = dealer[str_detect(dealer, "your regex here")]

# now, extract the relevant information
counts = str_match(count_lines, "your regex here")
...
dealer_table = mutate(dealer_table, dealer_name=str_replace(dealer_name, "your regex here", ""))
